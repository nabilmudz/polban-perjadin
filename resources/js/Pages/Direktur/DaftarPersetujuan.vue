...
watch(
  filters,
  debounce(() => {
    router.get(route('direktur.daftarpersetujuan'), filters, {
      preserveState: true,
      replace: true,
    })
  }, 300),
...
const submitDecision = (action) => {
    ...
    let routeName = '';
    switch(action) {
        case 'approve': routeName = 'direktur.approve'; break;
        case 'reject': routeName = 'direktur.reject'; break;
        case 'revise': routeName = 'direktur.revise'; break;
    }
