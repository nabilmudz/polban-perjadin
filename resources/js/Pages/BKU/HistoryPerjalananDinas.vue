      ...
      <div class="p-8">
        ...
        >
           ...
           <template #diusulkan_kepada="{ row }">
              <span class="text-gray-700">{{ row.wadir ? row.wadir.name : 'Wakil Direktur I' }}</span>
           </template>
           ...
           <template #created_at="{ row }">
            ...
            <template #tanggal_pelaksanaan="{ row }">
           ...
           <template #aksi="{ row }">
            <div class="flex gap-2 justify-center">
              ...
              <button v-if="row.status_surat === 'approved'" class="p-2 bg-green-600 text-white rounded shadow hover:bg-green-700 transition" title="Download">
...
const history = computed(() => {
    ...
    return {
        ...
        meta: {
            ...
            per_page: raw.per_page || raw.meta?.per_page || 10,
            from: raw.from || raw.meta?.from || 0,
            to: raw.to || raw.meta?.to || 0
        },
        links: raw.links || raw.meta?.links || []
    }
})
...
const columns = [
  ...
  { key: 'tanggal_pelaksanaan', label: 'Tanggal Berangkat', isDate: true },
  { key: 'nomor_surat_usulan_jurusan', label: 'Nomor Surat Pengantar' }, 
  { key: 'nomor_surat_resmi', label: 'Nomor Surat Tugas' },
  { key: 'updated_at', label: 'Tanggal Diterbitkan', isDate: true }, 
